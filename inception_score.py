...
def get_is (generator, num_img, val_batch_size, latent_dim):
    ...
    with torch.no_grad():
        ...
        imgs = F.interpolate(img_list, size=(299, 299), mode='bilinear', align_corners=False)
        is_mean, is_std = inception_score(imgs, cuda=True, batch_size=val_batch_size, resize=False, splits=1)
